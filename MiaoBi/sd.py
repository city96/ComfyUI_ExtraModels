...
from comfy import model_patcher, lora, supported_models_base, clip_vision, gligen, diffusers_convert, model_base, model_detection, utils
...
def load_checkpoint(config_path=None, ckpt_path=None, output_vae=True, output_clip=True, embedding_directory=None, state_dict=None, config=None):
    ...
    from . import MiaoBi_latent_formats
    model_config.latent_format = MiaoBi_latent_formats.SD15(scale_factor=scale_factor)
...
def load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, output_clipvision=False, embedding_directory=None, output_model=True):
    ...
    if output_model:
        model_patcher = model_patcher.ModelPatcher(model, load_device=load_device, offload_device=model_management.unet_offload_device(), current_device=inital_load_device)
