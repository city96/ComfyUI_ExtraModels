...
import traceback
import zipfile
from comfy import model_management, clip_model, ops
import json
import logging
...
class SDClipModel(torch.nn.Module, ClipTokenWeightEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cpu", max_length=77,
        ...
        if textmodel_json_config is None:
            ...
            textmodel_json_config = os.path.join(os.path.dirname(os.path.realpath(__file__)), "MiaoBi_clip.json")
            #custom clip_config
...
class SDTokenizer:
    def __init__(self, tokenizer_path=None, max_length=77, pad_with_end=True, embedding_directory=None, embedding_size=768, embedding_key='clip_l', tokenizer_class=AutoTokenizer, has_start_token=True, pad_to_max_length=True, min_length=None):
        if tokenizer_path is None:
            current_directory = os.path.dirname(os.path.abspath(__file__))
            tokenizer_path = os.path.join(os.path.dirname(current_directory), "MiaoBi", "tokenizer" )
            #custom tokenizer_path and tokenizer_class
        self.tokenizer = tokenizer_class.from_pretrained(tokenizer_path, trust_remote_code=True)
        self.max_length = max_length
